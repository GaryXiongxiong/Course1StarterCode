 ...
 * 
 * @author Your name here Last Editor: Gary J Description: Modify runablity by
 *         adding main method. Modify accessablity in China by changing map
 *         providers to Microsoft Date: July 17, 2015
 */
public class HelloWorld extends PApplet {
	 ...
	 * connection
	 */
	public static String mbTilesString = "UCSDUnfoldingMaps/data/blankLight-1-3.mbtiles";
	...
	public void setup() {
		...
		map2.zoomAndPanTo(zoomLevel, new Location(34.2f,109.0f));
